...
const updateStatusValidation = Joi.object({
  status: Joi.string()
    .trim()
    .valid("open_registration", "close_registration", "ongoing", "completed")
    .required()
    .messages({
      "string.base": "Trang thai phai la mot chuoi van ban.",
      "any.only":
        "Trang thai khong hop le. Chi chap nhan: open_registration, close_registration, ongoing, completed.",
