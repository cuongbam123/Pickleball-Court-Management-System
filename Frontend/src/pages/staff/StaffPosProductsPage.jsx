            ...
            <div>
              ...
              <input
                ...
                className={`w-full rounded-2xl border ${
                  productFormErrors.name ? "border-red-500 focus:ring-red-200" : "border-slate-200 focus:ring-emerald-100"
                } bg-white px-4 py-2.5 text-sm text-slate-900 focus:outline-none dark:border-slate-700 dark:bg-slate-950 dark:text-white`}
              />
              {productFormErrors.name && (
                <p className="mt-1 text-xs font-semibold text-red-500">{productFormErrors.name}</p>
              )}
            </div>
            ...
            <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
              ...
              <div>
                ...
                <input
                  ...
                  className={`w-full rounded-2xl border ${
                    productFormErrors.price ? "border-red-500" : "border-slate-200"
                  } bg-white px-4 py-2.5 text-sm text-slate-900 focus:outline-none dark:border-slate-700 dark:bg-slate-950 dark:text-white`}
                />
                {productFormErrors.price && (
                  <p className="mt-1 text-xs font-semibold text-red-500">{productFormErrors.price}</p>
                )}
              </div>
            </div>
            ...
            {productModalMode === "create" && (
              <div>
                ...
                <input
                  ...
                  placeholder="VD: 100"
                  className={`w-full rounded-2xl border ${
                    productFormErrors.stock ? "border-red-500" : "border-slate-200"
                  } bg-white px-4 py-2.5 text-sm text-slate-900 focus:outline-none dark:border-slate-700 dark:bg-slate-950 dark:text-white`}
                />
                {productFormErrors.stock && (
                  <p className="mt-1 text-xs font-semibold text-red-500">{productFormErrors.stock}</p>
                )}
              </div>
            )}
          </div>
            ...
            <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
              <div>
                ...
                <input
                  ...
                  className={`w-full rounded-2xl border ${
                    adjustFormErrors.amount ? "border-red-500" : "border-slate-200"
                  } bg-white px-4 py-2.5 text-sm text-slate-900 focus:outline-none dark:border-slate-700 dark:bg-slate-950 dark:text-white`}
                />
                {adjustFormErrors.amount && (
                  <p className="mt-1 text-xs font-semibold text-red-500">{adjustFormErrors.amount}</p>
                )}
              </div>
