    ...
    },
    {
      ...
      render: (item) => (
        <div className="flex gap-2">
          <Button variant="secondary" size="sm" onClick={() => alert("Edit " + item._id)}>
            Sửa
          </Button>
          <Button variant="danger" size="sm" onClick={() => deleteBranch(item._id)}>
            Xóa
          </Button>
        </div>
      ),
  ...
  const renderBranchCard = (branch) => (
    <div className="bg-white rounded-2xl border border-gray-200 p-5 hover:shadow-md transition-shadow h-full flex flex-col">
      <div className="flex justify-between items-start mb-4">
        ...
        <span className="bg-green-100 text-green-700 text-xs px-2 py-1 rounded-full font-medium">Hoạt động</span>
      </div>
      ...
      <div className="pt-4 border-t border-gray-100 flex justify-end gap-3 mt-auto">
        <button className="px-3 py-1.5 text-sm bg-blue-50 text-blue-600 rounded-lg hover:bg-blue-100 font-medium">
          Chỉnh sửa
        </button>
        <button 
      ...
      <div className="space-y-6">
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-slate-500 text-sm">Danh sách các cơ sở trên hệ thống</p>
          </div>
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="bg-white border rounded-lg p-1 flex items-center shadow-sm">
              ...
              >
                ...
                <svg width="20" height="20" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="3" y="3" width="18" height="18" rx="2" ry="2"></rect><line x1="3" y1="9" x2="21" y2="9"></line><line x1="3" y1="15" x2="21" y2="15"></line><line x1="9" y1="3" x2="9" y2="21"></line></svg>
              </button>
              <button 
            ...
            <button className="bg-blue-600 text-white px-4 py-2 rounded-xl font-medium hover:bg-blue-700 shadow-sm">
              + Thêm chi nhánh
            </button>
          </div>
        </div>
